...
import { FaFacebookF, FaTwitter, FaGoogle } from "react-icons/fa"; // Importing icons
      ...
      <nav className="bg-white shadow-lg sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center py-4">
          ...
          <div className="flex space-x-6">
            ...
            <Link to="/about" className="text-gray-600 hover:text-blue-600 font-semibold transition duration-300">
              Our Doctors
            </Link>
            <Link to="/services" className="text-gray-600 hover:text-blue-600 font-semibold transition duration-300">
            Podcast
            </Link>
            <Link to="/community" className="text-gray-600 hover:text-blue-600 font-semibold transition duration-300">
            Discussion
            </Link>
